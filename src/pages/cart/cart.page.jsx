...
const Cart = () => {
    ...
    useEffect(() => {
        const products = PRODUCTS_DATA.filter((item) => Object.keys(cartIds).includes(item.id.toString()));
    ...
    const total = () => {
        ...
        for (let i = 0; i < cartItems.length; i++) {
            ...
            totalPrice += getItemFromStorage(cartItems[i].id).count * cartItems[i].price;
        }
        return totalPrice;
    };
